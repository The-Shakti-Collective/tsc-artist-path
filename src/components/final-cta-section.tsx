...
export function FinalCtaSection() {
  return (
    <section id="apply" className="mx-auto max-w-6xl px-4 pb-20 md:pb-28">
      <div
        className="relative overflow-hidden rounded-3xl bg-brand-teal-deep bg-gradient-to-br from-brand-teal-deep via-brand-teal-mid to-brand-green shadow-soft-lg"
      >
        <BrandPattern variant="hero" className="pointer-events-none absolute inset-0 opacity-20" />
        <div
          className="pointer-events-none absolute -right-16 top-0 h-56 w-56 rounded-full bg-brand-pumpkin/25 blur-3xl"
          aria-hidden
        />

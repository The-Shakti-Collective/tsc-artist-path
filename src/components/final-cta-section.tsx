...
export function FinalCtaSection() {
  ...
  return (
    <section id="apply" className="mx-auto max-w-6xl px-4 pb-20 md:pb-28">
      <Reveal>
        <div className="relative overflow-hidden rounded-3xl bg-brand-red-oxide bg-gradient-to-br from-brand-red-oxide via-brand-burgundy to-brand-espresso shadow-soft-lg">
